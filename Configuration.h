 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT 0 //Zonalimitatore, this is the line that gives syntax error when set on -1 because it rejects the minus.

/**
 * Select a secondary serial port on the board to use for communication with the host.
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
//#define SERIAL_PORT_2 0 //Zonalimitatore, this also the line that gives syntax error when set on -1 .
 ...
 */
#define BAUDRATE 250000 //Zonalimitatore, I have tried 9600, 115200 and 250000 .
